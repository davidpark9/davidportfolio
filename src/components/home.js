...
export default function Home() {
  ...
  // })
    ...
    return (
        <section id="home">
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center bg-white-500 rounded-s-xl">
         ...
         <p className="mb-1 text-3xl text-slate-400 leading-relaxed">
          ...
          <div className ="flex justify-center">
            <a
            href="#contact"
            className="text-zinc-800  bg-gray-100 border-0 py-2 px-9 shadow-md focus:outline-none hover:drop-shadow-md hover:bg-gray-100 rounded text-lg flex-auto ">
            Contact
            </a>
            <a
            href="#projects"
